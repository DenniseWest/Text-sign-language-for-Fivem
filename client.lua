...
local Labels = {
    cs = { prefix = "IC-Překlad", overhead = "*ukazuje znakovou reci*" },
    en = { prefix = "IC-Translation", overhead = "*uses sign language*" },
    es = { prefix = "IC-Traducción", overhead = "*usa el lenguaje de señas*" },
    de = { prefix = "IC-Übersetzung", overhead = "*benutzt Gebärdensprache*" },
    fr = { prefix = "IC-Traduction", overhead = "*utilise la langue des signes*" },
    ru = { prefix = "IC-Перевод", overhead = "*использует язык жестов*" },
    zh = { prefix = "IC-翻译", overhead = "*使用手语*" },
    ar = { prefix = "IC-ترجمة", overhead = "*يستخدم لغة الإشارة*" },
    pt = { prefix = "IC-Tradução", overhead = "*usa linguagem gestual*" }
}
